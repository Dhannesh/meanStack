...
var CartComponent = /** @class */ (function () {
    function CartComponent(router, toastr, http, commonservice) {
        var _this = this;
        this.router = router;
        this.toastr = toastr;
        this.http = http;
    ...
    CartComponent.prototype.remove = function (item) {
        ...
        this.http.post(removefromcartapi, robj)
            .subscribe(function (response) {
            var index = _this.cartitems.indexOf(item);
            console.log(index);
            _this.commonservice.cartitems.splice(index, 1);
            console.log("response ", response);
            _this.toastr.success("Removed from cart");
            _this.totalPrice -= item.productprice;
        });
    };
...
var CheckoutComponent = /** @class */ (function () {
    function CheckoutComponent(router, toastr, http, commonservice) {
        var _this = this;
        this.router = router;
        this.toastr = toastr;
        this.http = http;
        ...
        if (!localStorage.email) {
            ...
            if (this.commonservice.cartitems.length > 0) {
                ...
                this.http.post(cartapi, { email: localStorage.email })
                    ...
                    _this.commonservice.cartitems = response["data"];
                    if (_this.cartitems.length > 0) {
                        _this.totalItems = _this.commonservice.cartitems.length;
                        _this.cartitems.forEach(function (each) {
                            _this.totalPrice = _this.totalPrice + each.productprice;
                        });
                    }
    ...
    CheckoutComponent.prototype.placeOrder = function () {
        ...
        this.http.post(placeorderapi, requestObj)
            ...
            _this.toastr.success("Order Placed Success");
            if (response["code"] == 200) {
                _this.clearCart();
                _this.commonservice.cartitems = [];
                _this.router.navigate(['/orderdetails']);
            }
        }, function (error) {
            console.log("Error from placeing order ", error);
        });
    };
    CheckoutComponent.prototype.clearCart = function () {
...
var OrderdetailsComponent = /** @class */ (function () {
    function OrderdetailsComponent(router, toastr, http, commonservice) {
        var _this = this;
        this.router = router;
        this.toastr = toastr;
        this.http = http;
        ...
        this.http.post(getorderdetailsapi, { email: localStorage.email })
            ...
            console.log("orders are ", _this.orders);
        }, function (error) {
            console.log("error here ", error);
        });
    }
...
var ProductdetailsComponent = /** @class */ (function () {
    function ProductdetailsComponent(http, router, toastr, currentroute, commonservice) {
        var _this = this;
        this.http = http;
        this.router = router;
        this.toastr = toastr;
    ...
    ProductdetailsComponent.prototype.goToCart = function () {
        if (localStorage.email) {
    ...
    ProductdetailsComponent.prototype.addToCart = function () {
        ...
        if (localStorage.email) {
            ...
            this.http.post(addtocartapi, robj).subscribe(function (response) {
                if (response["code"] = 200) {
                ...
                _this.toastr.error("error in adding to cart", error);
            });
        }
        else {
            this.router.navigate(['/login']);
